...
function ServicesHero() {
  return (
    <div className='max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg h-screen flex flex-col md:flex-row gap-8 justify-center items-center m-auto px-4'>
        ...
        <div className='md:w-[30%] md:h-[24rem] flex flex-col sm:flex-row md:relative gap-4 pb-96'>
